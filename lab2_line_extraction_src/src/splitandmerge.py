...
import numpy as np
import math
from engr4200_basics_src_lib.functions import angle_wrap
...
def splitandmerge(points, split_thres=0.1, inter_thres=0.3, min_points=6, dist_thres=0.12, ang_thres=np.deg2rad(10)):
    ...
    '''
    return split(points, split_thres, inter_thres, min_points, 0, points.shape[1]-1)
...
def split(points, split_thres, inter_thres, min_points, first_pt, last_pt):
    ...
    normal_magnitude = math.sqrt(a**2 + b**2)
